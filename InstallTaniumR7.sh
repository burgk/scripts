...
VERBOSITY=0
SERVERPORT=17472
TANIUMRH7RPMSUM="84158937aa804380d4c9897cff14909d25b92313caae0f15f94ea8873dc389fe"
...
if (( $? == 0 ))
 ...
 if [[ ${TANIUMRH7RPMSUM} != $(sha256sum ${INSTALLPKG} | awk -F' ' '{ print $1 }') ]]
  then
